...
class Pics:
    ...
    reset_player_name_btn = pic_params(r'reset_player_name_btn', reg=(1231, 540, 195, 175))
    reset_filter_btn = pic_params(r'reset_filter_btn', reg=(1195, 760, 216, 204))
    ...
    type_player_name = pic_params(r'type_player_name', reg=(7, 520, 624, 220))
    ...
    confirm_buy_now_btn = pic_params(r'confirm_buy_now', reg=(196, 1670, 133, 100))
    item_detail_checkpoint = pic_params(r'item_detail_checkpoint', reg=(452, 88, 556, 155))
    purchase_approved = pic_params(r'purchase_approved', reg=(250, 1140, 525, 126))

    list_on_transfer_market_btn = pic_params(r'list_on_transfer_market_btn')
    list_for_transfer_btn = pic_params(r'list_for_transfer_btn', reg=(400, 1700, 768, 222))
    approved_status_coin = pic_params(r'approved_status_coin')

    coin_buy_now = pic_params(r'coin_buy_now', reg=(580, 1230, 350, 120))
    ...
    new_items_full_btn = pic_params(r'new_items_full_btn')
